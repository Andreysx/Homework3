...
```
Примерный алгоритм при работе с удаленными репозиториями на GITHUB

1. Создать аккаунт на GITHUB.
2. Создать локальный репозиторий.
3. Подружить ваш локальный репозиторий и удаленный репозиторий.GITHUB подскажет как это сделать.
4. Отправить (push) ваш локальный репозиторий в удаленный (на GITHUB) при этои возможно вам нужно будет авторизоваться на удаленном репозитории.
...
### Для этого существует команда ***git pull request***. Эта команда позволяет отправить запрос на вливание изменений в чей-либо репозиторий на GITHUB.
 ...
 ## **Все изменения которые мы хотим предложить делаются в новой созданной нами ветке!!!**

 ***Инстукция как делать pull requestы:***

1. Делаем Fork интересующего нас аккаунта(репозитория).
2. Выполняет команду git clone в наш локальный репозиторий.
3. Создаем ветку с предлагаемыми изменениями.
4. Производим все изменения только в этой ветке.
5. Отправляем изменения на свой аккаунт(git push)(изменения должны быть обязательно зафиксированны).
6. В окне на GITHUB появляется возможность отправть pull request с вашими изменениями(или же это можно сделать вручную при помощи интерактивного интерфейса GITHUB).

## 13 Полезные команды.
~~~
git branch --all - посмотреть ветки в удаленном репозитории.

git log--oneline--all--graph - все комиты во всех ветках, видна вся история репозитория.

git checkout -b <branch name> - создать новую ветку и сразу же перейти в нее.
~~~
