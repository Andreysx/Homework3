...
### Для этого существует команда ***git pull request***. Этак оманда позволяет отправить запрос на вливание изменений в чей-либо репозиторий на GITHUB.
 Но для начала нам нужно собственно получить сам репозиторий и перенести его в нашу локальную копию.
 
 Тут нам приходит на помощь команда FORK которая выполняет
